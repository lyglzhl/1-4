...
export const MENTORS: Mentor[] = [
  {
    name: "Muhammad老师",
    title: "英国医学院教授｜临床医学申请与英联邦执医考试全流程辅导导师｜MRCP 体系训练",
    specialties: ["英联邦执业医师资格考试辅导","本科临床医学/UCAT全程申请规划与面试辅导（含G5录取）","临床医学核心科目系统强化","研究生入学医学（GEM）及 MCAT 相关辅导"]
  },
  {
    name: "Joanna老师",
    title: "医学面试与英联邦执业考试专项导师 | 英国在职医生｜ G5临床医学面试辅导",
    specialties: ["英联邦临床医学面试辅导（MMI / Panel面试技巧与模拟）","英联邦执业医师资格考试学术辅导","医学个人陈述与研究计划深度优化","UCAT策略备考与临床沟通能力训练"]
  },
  {
    name: "皋老师",
  ...
  {
    name: "Zoe 老师",
    title: "香港大学口腔医学博士｜香港大学应用口腔科学学院讲师及研究助理",
    specialties: ["医学×材料科学×生物医学交叉方向博士申请规划","博士阶段科研能力构建、研究方向定位与科研辅导","医学研究型背景梳理与学术能力呈现"]
  },
  {
    name: "Jessie 老师｜学术导师",
    title: "剑桥大学心理学本科｜伦敦大学学院临床心理学硕士｜英国心理学会会员",
    specialties: ["牛津、剑桥等顶尖院校申请逻辑与学术能力训练","入学笔试、面试及综合学术评估准备","多国本硕博申请整体策略规划"]
  },
  {
    name: "Eddy 老师",
